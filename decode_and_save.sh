...
TEST_SET_SIZE=${5:-1000}  # Default to 1000 test samples if not provided
REGION=${6:-lh_hV4} 
...
CMD="python decode_and_save.py --model_name $MODELNAME --image_sample $IMAGE_SAMPLE --P $P --kernel $KERNEL --test_set_size $TEST_SET_SIZE --region $REGION"
